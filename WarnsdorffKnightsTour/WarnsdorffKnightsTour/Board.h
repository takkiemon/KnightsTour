...
#define _BOARD_
	...
	private:
		int boardSize;
		int* boardGrid;//contains the board. holds 0-8 for the number of available next spaces, holds -1 for traversed and untraversible spaces, holds -2 for the knight
